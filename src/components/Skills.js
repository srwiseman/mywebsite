  ...
  render() {
    ...
    <div className="skills">
      ...
      <FadeIn>
          ...
          <p>Here are some things I'm good at! <strong>This isn't an exhaustive list, and it's going to be a work in progress</strong>. I don't think it's good enough just to say I'm good at things (otherwise I'd just say I'm good at eveything!). So I'll try to backup my claims and provide links to code as much as possible!</p>
